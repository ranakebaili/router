export const Data = [
    ...
    },
    {
        ...
        rate: 3,
        description:
            "In a dystopian near future, single people, according to the laws of The City, are taken to The Hotel, where they must find a romantic partner in 45 days or are transformed into beasts and sent off into The Woods.",
        posterUrl:
        ...
        },
    {
        ...
        rate: 1,
        description:
            "After the devastating events of Avengers, the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to reverse Thanos' actions and restore balance to the universe.",
        posterUrl:
